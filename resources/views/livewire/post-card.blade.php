            ...
            <div class="col-md-6">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <textarea class="form-control w-100" id="postContent" rows="13"
                                        placeholder="What do you want to talk about?" wire:model="content"></textarea>
                                    @error('content')
                ...
                <div class="overlay @if ($showCard) d-flex @else d-none @endif ">
                    <div class="card post-card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <textarea class="form-control w-100" id="postContent" rows="6"
                                    placeholder="What do you want to talk about?" wire:model="content"></textarea>
                                @error('content')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
