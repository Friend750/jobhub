                ...
                <div class="project-block">
                    ...
                    <div class="row mb-3">
                        <div class="form-group mb-3 col-md-12">
                            <label class="mb-2"
                                for="project_title_{{ $index }}">{{ __('general.project_title') }}</label>
                            <input type="text"
                        ...
                        <div class="form-group mb-3 col-md-12">
                            <label class="mb-2"
                                for="project_description_{{ $index }}">{{ __('general.project_description') }}</label>
                            <textarea class="form-control @error("ProjectsForm.projects.{$index}.description") is-invalid @enderror"
                                ...
                                placeholder="{{ __('general.placeholder_project_description') }}" rows="3"
                        ...
                        <div class="form-group mb-3 col-md-12">
                            <label class="mb-2"
                                for="project_contributions_{{ $index }}">{{ __('general.project_contributions') }}</label>
                            <textarea class="form-control @error("ProjectsForm.projects.{$index}.contributions") is-invalid @enderror"
                                ...
                                placeholder="{{ __('general.placeholder_project_contributions') }}" rows="2"
                                oninput="this.style.height = ''; this.style.height = (this.scrollHeight+5) + 'px'"></textarea>
