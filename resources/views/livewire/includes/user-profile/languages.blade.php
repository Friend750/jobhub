...
<div x-data="languageComponent()">
            ...
            <ul class="list-unstyled d-flex flex-wrap">
                ...
                <template x-for="(language, index) in languages" :key="language.id">
                    <li class="btn btn-outline-secondary m-1" x-show="index < limit" x-text="language.language"
                        @click="openEditModal(language)" data-bs-toggle="tooltip" title="Click to Edit">
                    </li>
                </template>
    ...
    <!-- Language Modal -->
    <div class="modal fade overflow-hidden" id="EditLanguage" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Search Input -->
                    <input type="text" x-model="searchQuery" placeholder="Search languages..."
                    ...
                    <div class="text-center mt-3">
                        <small class="text-muted">Or you can just delete the current Language "<span x-text="previousLanguage" class="fw-bold"></span>"</small>
