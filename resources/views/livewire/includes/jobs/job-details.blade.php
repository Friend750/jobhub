<div x-show="selectedJob" class="job-details bg-white p-4 rounded-3 shadow-sm"
    style="position: sticky; top: 6rem; max-height: 72vh;
    overflow: auto;">
    ...
    <template x-if="selectedJob.job_tasks">
        <div class="mb-4">
            <h6 class="fw-bold mb-2">Key Responsibilities:</h6>
            <div x-html="'• ' + selectedJob.job_tasks.replace(/\n/g, '<br>• ')"></div>
        </div>
    </template>

    <!-- Job Conditions -->
    <template x-if="selectedJob.job_conditions">
        <div class="mb-4">
            <h6 class="fw-bold mb-2">Job Conditions:</h6>
            <div x-html="'• ' + selectedJob.job_conditions.replace(/\n/g, '<br>• ')"></div>
        </div>
    </template>
