        ...
        <div class="col-md-6">
            <div class="card rounded border" style="min-height: 80vh;">
                <div class="p-3 card-img-top text-center text-muted">
                    <h4 class="">{{ __('general.companies') }}</h4>
                </div>
                ...
                @forelse ($companies as $company)
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3 withHover">
                        <div style="cursor: pointer" class="d-flex align-items-center" x-data
                            ...
                            <!-- Default image -->
                            <img src="{{ $company['user_image'] }}" alt="Logo" class="rounded-circle ms-2"
                                style="
                                    object-fit: cover;
                                    width: 50px;
                                    height: 50px;">
                            ...
                            <div class="ms-3">
                                <strong>{{ $company['name'] ?? 'null' }}</strong>
                    ...
                    <div class="d-flex justify-content-center align-items-center py-4">
                        <a href="/Search">
                            <button class="btn btn-primary">
                                {{ __('general.search_for_companies') }}
                            </button>
                        </a>
                    </div>
                @endforelse
