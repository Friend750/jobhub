        ...
        <div class="bg-white rounded shadow-sm flex-grow-1">
            ...
            <div class="chat-list">
                ...
                <a href="#" class="text-decoration-none text-dark">
                    <div
                        class="d-flex align-items-center clickable-div py-1 pl-3 justify-content-start">
                ...
                <a href="#" class="text-decoration-none text-dark">
                    <div
                        class="d-flex align-items-center mb-1 clickable-div py-1 pl-3 justify-content-start">
                        <img src="https://via.placeholder.com/50" alt="User"
                            class="rounded-circle me-3 mr-3">
                        <div>
                            <strong>Company name</strong>
