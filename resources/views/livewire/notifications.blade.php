<div class="container mt-4 col-6 bg-white mb-3">
    <div class="row">
        <!-- قسم الإحصائيات -->
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active text-dark" id="tab1-tab" data-bs-toggle="tab"
                                   href="#All" role="tab" aria-controls="All" aria-selected="true">
                                   All
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-dark" id="tab2-tab" data-bs-toggle="tab"
                                   href="#Mentions" role="tab" aria-controls="Mentions" aria-selected="false">
                                   Mentions
                                </a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-dark" id="tab3-tab" data-bs-toggle="tab"
                            ...
                            <div class="tab-pane fade show active text-center" id="All" role="tabpanel" aria-labelledby="tab1-tab">
                                ...
                                <div class="alert alert-light d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div>
                                            <button class="btn btn-sm blue" wire:click="acceptRequest">Accept</button>
                                            <button class="btn btn-sm" wire:click="declineRequest">Decline</button>
                                        </div>
                                    </div>
                                    <span>15h</span>
                                </div>
